...
/length <значение> - длина цепочки
/order <значение> - количество условий на порядок
/relative <значение> - количество условий на относительный порядок
/content <значение> - количество условий на содержание
/equal <значение> - количество условий на равенство
/true <значение> - доля истинных утверждений
/colornames <значение> - написание названий цветов ("режим дальтоника")
/bordersize <значение> - размер границ
/offset <значение> - отступ сверху
/end <значение> - отступ снизу
/beadsize <значение> - размер бусины
/levelsize <значение> - размер уровня бусин
